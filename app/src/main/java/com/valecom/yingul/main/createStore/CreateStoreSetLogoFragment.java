            ...
            public void onClick(View v) {
                Intent viewIntent =
                        new Intent("android.intent.action.VIEW",
                                Uri.parse("https://s3-us-west-2.amazonaws.com/jsa-s3-bucketimage/image/store/sampleLogo.jpg"));
            ...
            case ADD_PICTURES_TAG:
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    if (null != data) { // checking empty selection
                        if (null != data.getClipData()) { // checking multiple selection or not
                            ...
                            for (int i = 0; i < data.getClipData().getItemCount(); i++) {
                                ...
                                try {
                                    ...
                                    if (i == 0) {
                                        ((CreateStoreActivity)getActivity()).store.setMainImage("data:image/jpeg;base64," + encodedImage);
                                    } else {
                        ...
                        CreateStoreSetBannerFragment fragment = new CreateStoreSetBannerFragment();
