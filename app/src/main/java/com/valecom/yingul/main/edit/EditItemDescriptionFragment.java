 ...
 */
public class EditItemDescriptionFragment extends Fragment {
    ...
    public EditItemDescriptionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editDescription2.setText(bundle.getString("data"));

        buttonSetDescription2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String description = editDescription2.getText().toString().trim();

                String edit = "{\"itemId\":"+itemId+",\"description\":\""+description+"\"}";
                String url = Network.API_URL+"item/updateDescription";
