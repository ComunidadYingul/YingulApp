...
public class OverActivity extends AppCompatActivity {
        ...
        lay_filter_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(array_cat_list.isEmpty()){
                    Toast.makeText(OverActivity.this, "No hay productos para filtrar", Toast.LENGTH_LONG).show();
                }else {
                    Intent intent = new Intent(OverActivity.this, FilterActivity.class);
                    Gson json = new Gson();
    ...
    public ArrayList<Yng_Item> loadJSONFromAssetCategoryList() {
        ...
        JsonArrayRequest postRequest = new JsonArrayRequest(Network.API_URL + "item/over/true",
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        {
                            //if (isAdded()) {
                            Toast.makeText(OverActivity.this, R.string.error_try_again_support, Toast.LENGTH_LONG).show();
                            //}
                        }
            ...
            public void onErrorResponse(VolleyError error)
            {
                ...
                if (response != null && response.data != null)
                {
                    try
                    {
                        ...
                        Toast.makeText(OverActivity.this, json.has("message") ? json.getString("message") : json.getString("error"), Toast.LENGTH_LONG).show();
                    }
                    catch (JSONException e)
                    {
                        Toast.makeText(OverActivity.this, R.string.error_try_again_support, Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
                    Toast.makeText(OverActivity.this, error != null && error.getMessage() != null ? error.getMessage() : error.toString(), Toast.LENGTH_LONG).show();
                }
            }
        })
        {
        ...
        MySingleton.getInstance(OverActivity.this).addToRequestQueue(postRequest);
