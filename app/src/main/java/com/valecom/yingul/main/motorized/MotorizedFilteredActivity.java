...
public class MotorizedFilteredActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*************/
        /**********/
        minPrice = (Long) getIntent().getSerializableExtra("minPrice");
        maxPrice = (Long) getIntent().getSerializableExtra("maxPrice");
        maxYear = (Long) getIntent().getSerializableExtra("maxYear");
        minYear = (Long) getIntent().getSerializableExtra("minYear");
        category = (Long) getIntent().getSerializableExtra("category");
        ...
        lay_filter_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(array_cat_list.isEmpty()){
                    Toast.makeText(MotorizedFilteredActivity.this, "No hay productos para filtrar", Toast.LENGTH_LONG).show();
                }else {
                    Intent intent = new Intent(MotorizedFilteredActivity.this, FilterActivity.class);
                    Gson json = new Gson();
    ...
    public ArrayList<Yng_Item> loadJSONFromAssetCategoryList() {
        ...
        progressDialog.show();
        Log.e("url",Network.API_URL + "item/searchMotorized/"+category+"/"+minPrice+"/"+maxPrice+"/"+minYear+"/"+maxYear);
        JsonArrayRequest postRequest = new JsonArrayRequest(Network.API_URL + "item/searchMotorized/"+category+"/"+minPrice+"/"+maxPrice+"/"+minYear+"/"+maxYear,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        {
                            //if (isAdded()) {
                            Toast.makeText(MotorizedFilteredActivity.this, R.string.error_try_again_support, Toast.LENGTH_LONG).show();
                            //}
                        }
            ...
            public void onErrorResponse(VolleyError error)
            {
                ...
                if (response != null && response.data != null)
                {
                    try
                    {
                        ...
                        Toast.makeText(MotorizedFilteredActivity.this, json.has("message") ? json.getString("message") : json.getString("error"), Toast.LENGTH_LONG).show();
                    }
                    catch (JSONException e)
                    {
                        Toast.makeText(MotorizedFilteredActivity.this, R.string.error_try_again_support, Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
                    Toast.makeText(MotorizedFilteredActivity.this, error != null && error.getMessage() != null ? error.getMessage() : error.toString(), Toast.LENGTH_LONG).show();
                }
            }
        })
        {
        ...
        MySingleton.getInstance(MotorizedFilteredActivity.this).addToRequestQueue(postRequest);
