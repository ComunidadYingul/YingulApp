...
public class PropertyFilteredActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*************/
        /**********/
        condition = (String) getIntent().getSerializableExtra("condition");
        typeUbication = (String) getIntent().getSerializableExtra("typeUbication");
        idTypeUbication = (Integer) getIntent().getSerializableExtra("idTypeUbication");
        if(getIntent().getSerializableExtra("category")!=null){
            category = new Yng_Category();
            category = (Yng_Category) getIntent().getSerializableExtra("category");
        }else{
            category = null;
        }
    ...
    public ArrayList<Yng_Item> loadJSONFromAssetCategoryList() {
        ...
        if(category==null){
            ...
            url = Network.API_URL + "item/searchPropertyCategoryConditonUbication/0/"+condition+"/"+typeUbication+"/"+idTypeUbication;
            Log.e("url",Network.API_URL + "item/searchProperty/All/"+condition+"/"+typeUbication+"/"+idTypeUbication);
        }
        JsonArrayRequest postRequest = new JsonArrayRequest(url,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        {
                            //if (isAdded()) {
                            Toast.makeText(PropertyFilteredActivity.this, R.string.error_try_again_support, Toast.LENGTH_LONG).show();
                            //}
                        }
            ...
            public void onErrorResponse(VolleyError error)
            {
                ...
                if (response != null && response.data != null)
                {
                    try
                    {
                        ...
                        Toast.makeText(PropertyFilteredActivity.this, json.has("message") ? json.getString("message") : json.getString("error"), Toast.LENGTH_LONG).show();
                    }
                    catch (JSONException e)
                    {
                        Toast.makeText(PropertyFilteredActivity.this, R.string.error_try_again_support, Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
                    Toast.makeText(PropertyFilteredActivity.this, error != null && error.getMessage() != null ? error.getMessage() : error.toString(), Toast.LENGTH_LONG).show();
                }
            }
        })
        {
        ...
        MySingleton.getInstance(PropertyFilteredActivity.this).addToRequestQueue(postRequest);
